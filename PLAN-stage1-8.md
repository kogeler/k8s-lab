Этот файл владеет §21..§23: Stage-1-wide meta — out-of-scope fence
(§21), self-review против исходного контракта (§22) и финальная
рекомендация execution order'а (§23). Нумерация §N сквозная по всем
...
(§15..§20) сейчас в работе, поэтому coding-agent'у удобно держать эти
...
PLAN-stage1-8.md ................. §21..§23 (Stage 1 meta: out-of-scope, self-review, recommendation)  <-- этот файл
```
