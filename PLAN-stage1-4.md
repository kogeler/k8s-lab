...
* default topology = `clusters.management_controlplane_count` (1)
  + `clusters.management_worker_count` (1) — см. §8 контракт
...
* default topology = `clusters.workload_controlplane_count` (2)
  + `clusters.workload_worker_count` (2) — см. §8 контракт
